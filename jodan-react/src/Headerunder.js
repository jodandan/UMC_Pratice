        ...
        <div id="header_under_content">
            <div className="inflearnlogo">
                <a href="https://www.inflearn.com/">
                    <svg width="110" viewBox="0 0 433 90" xmlns="http://www.w3.org/1999/xlink">
                        <image src="./public/인프런 브랜드 로고"href="인프런 브랜드 로고.svg"></image>
                    </svg>
                </a>
            </div>
                    ...
                    <div className="dropdown">
                      <button className="dropbtn change_green lecture">강의</button>
                        <div className="dropdown-content">
                          ...
                          <Link to="https://www.inflearn.com/community/chats">
                            <span>자유주제</span>
                          </Link>
                          <Link to="https://www.inflearn.com/community/studies">
                            <span>스터디</span>
                          </Link>
                          <Link to="https://www.inflearn.com/community/projects">
                            <span>팀 프로젝트</span>
                          </Link>
                          <Link to="https://www.inflearn.com/blogs">
                            <span>블로그</span>
                          </Link>
                        </div>
                    </div>
            ...
            <BrowserRouter>
                <div className="loadmap">
                  <Link className="change_green" to="https://www.inflearn.com/roadmaps">로드맵</Link>
                </div>
            </BrowserRouter>
            <BrowserRouter>
                <div className="mentoring">
                  <Link className="change_green" to="https://www.inflearn.com/mentors">멘토링</Link>
                </div>
            </BrowserRouter>
            <BrowserRouter>
            ...
            <div className="inflean">
                <BrowserRouter>
                    <div className="dropdown">
                        ...
                        <div className="dropdown-content">
                            <Link to="https://www.inflearn.com/community/reviews">
                                <span>
                            ...
                            <Link to="https://www.inflearn.com/community/mentorings-reviews">
                                <span>
                            ...
                            <Link to="https://www.inflearn.com/pages">
                                <span>
                            ...
                            <Link to="https://www.inflearn.com/request-to-inflearn">
                                <span>
            ...
            <div className="header_under_content_menu_right">
                <div className="searchbox">
                    <div className="search">
                        ...
                        <img className="in_textbox" alt="searchbox" src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/icon/search.png" />
                    </div>
                </div>
            </div>
